...
import com.automationpractice.utils.enuns.users.Datum;
...
public class AdicionarDoisItensNoCarrinhoLogarFinalizarCompraComSucessoTestCase {
    ...
    public void main() {
        ...
        try {
            ...
            Report.appendScenarioTest("AdicionarDoisItensNoCarrinhoLogarFinalizarCompraComSucesso");
            ...
            authenticationTasks.fillInRegisteredEmailAddressAccountTextfield(Datum.EMAIL.getValue());
            authenticationTasks.fillInRegisteredPasswordAccountTextfield(Datum.PASSWORD.getValue());
            authenticationTasks.clickRegisteredSignInButton();
            authenticationFormPageTasks.clickCartButton();
